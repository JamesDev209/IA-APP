        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-panel inline-block p-2 rounded-2xl">
              <div className={`${project?.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} sm:max-h-140 rounded-xl bg-gray-900 overflow-hidden relative`}>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-2xl">
              ...
              <div className="flex flex-col gap-3">
                <a href={project?.generatedImage} download>
                  <GhostButton disabled={!project?.generatedImage} className="w-full justify-center rounded-md py-3 disabled:opacity-50
                ...
                <a href={project?.generatedVideo} download>
                  <GhostButton disabled={!project?.generatedVideo} className="w-full justify-center rounded-md py-3 disabled:opacity-50
                  disabled:cursor-not-allowed">
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              {!project?.generatedVideo ? (
                ...
                <div className="p-3 bg-green-500/50 border border-green-500/20 rounded-xl text-green-400 text-center text-sm font-medium">Generate video succesfully</div>
              )
              }
            </div>
          </div>
